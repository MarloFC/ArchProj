...
export function ComparisonSection({ config }: ComparisonSectionProps) {
  ...
  const beforeAfterTitle = config?.beforeAfterTitle || ""
  const beforeAfterDescription = config?.beforeAfterDescription || ""
